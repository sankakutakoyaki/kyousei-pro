...
public class StaffEntity extends EmployeeEntity {
    ...
    public String getInsertString() {
        ...
        sb.append(" VALUES ('" + this.getUser_name() + "', 'staff', '作成', 'ID=' + CONVERT(nvarchar,@NEW_EMP_ID));");
    ...
    public String getUpdateString() {
        ...
        sb.append(" WHERE staff_id = " + this.getStaff_id() + ";");
        // 変更履歴
        sb.append("INSERT INTO staffs_log SELECT * FROM @StaffTable;");
        sb.append("INSERT INTO history (user_name, table_name, state, contents) VALUES (");
        sb.append("'" + this.getUser_name() + "', 'staffs', '更新', 'ID=" + this.getEmployee_id() + "');");
    ...
    public String getDeleteString() {
        ...
        // 変更履歴
        sb.append("INSERT INTO history (user_name, table_name, state, contents) VALUES (");
        sb.append("'" + this.getUser_name() + "', 'staffs', '削除', 'ID=" + (this.getIds() == null ? "0": this.getIds().substring(3)) + "');");
        // 削除が失敗していれば０を返す
    ...
    private String logString(String process) {
        ...
        sb.append(", INSERTED.staff_id");
        sb.append(", INSERTED.employee_id");
        // sb.append(")");
        sb.append(" INTO @StaffTable (");
        sb.append("editor");
        sb.append(", process");
