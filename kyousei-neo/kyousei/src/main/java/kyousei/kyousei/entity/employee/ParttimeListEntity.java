...
@Data
public class ParttimeListEntity implements IEntity {
    ...
    public String getParttimeListString() {
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT e.*, o.office_id, o.office_name, p.full_name, p.full_name_kana, NULLIF(p.phone_number, '') as phone_number, pt.* From employees e");
