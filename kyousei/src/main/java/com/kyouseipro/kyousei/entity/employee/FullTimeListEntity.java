...
@Data
public class FullTimeListEntity implements IListEntity {
    ...
    public String getSelectString() {
        ...
        sb.append("SELECT e.*, f.*, c.company_name, o.office_id, o.office_name, p.full_name, p.full_name_kana, p.phone_number From employees e");
        sb.append(" INNER JOIN fulltimes f ON f.employee_id = e.employee_id AND f.state = " + Enums.state.INITIAL.getNum());
