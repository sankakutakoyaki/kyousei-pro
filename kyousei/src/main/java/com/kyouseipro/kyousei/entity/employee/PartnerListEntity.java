...
@Data
public class PartnerListEntity implements IListEntity {
    ...
    public String getSelectString() {
        ...
        sb.append("SELECT e.*, c.company_name, o.office_name, p.full_name, p.full_name_kana, p.phone_number, pa.* From employees e");
